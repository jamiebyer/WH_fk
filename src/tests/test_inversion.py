import pytest
import numpy as np
from inversion.forward_model import SyntheticData, Model
...
def test_sampling_prior(setup_data, rerun=False):
    ...
    # in_path = "./results/inversion/sample_prior.nc"
    in_path = "./results/inversion/resultssample_prior.nc"
